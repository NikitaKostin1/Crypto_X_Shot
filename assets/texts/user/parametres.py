...
parametres = """ \
Настройки параметров аккаунта <b>Crypto Shot</b>:
...
Обращаем Ваше внимание - результат работы НАПРЯМУЮ зависит от заданных Вами настроек <b>Crypto Shot</b>!
...
spread_type_error = """
Неверный ввод!
Вы можете вводить только целые и дробные числа, пример:
<code>0.75</code> | <code>2</code> | <code>3.1</code>
"""
spread_min_error = """
Минимальный спред 0.5%, c настройками ниже слишком много связок.
"""
spread_max_error = """
